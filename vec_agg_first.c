...
Datum vec_agg_first_finalfn(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(vec_agg_first_finalfn);

/**
 * Extract an array of firsts from a VecAggAccumState.
 */
Datum
vec_agg_first_finalfn(PG_FUNCTION_ARGS)
{
  ArrayType *result;
